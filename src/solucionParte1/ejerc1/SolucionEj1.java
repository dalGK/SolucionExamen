...
public class SolucionEj1 {
	...
	public static void main(String[] args) {
		...
		//recorrer para imprimir todos los países con la misma puntuación para no tener que hacer dos for uno para buscar el primero y otro para
